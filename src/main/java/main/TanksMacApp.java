...
public class TanksMacApp
{
    public static void main(String[] args)
    {
        ...
        if (!Game.isOnlineServer)
        {
            ...
            if (Game.framework == Game.Framework.lwjgl)
            {
                Game.game.window = new LWJGLWindow("Tanks: Fortress Wars", 1400, 900 + Drawing.drawing.statsHeight, Game.absoluteDepthBase, new GameUpdater(), new GameDrawer(), new GameWindowHandler(), Game.vsync, !Panel.showMouseTarget);
